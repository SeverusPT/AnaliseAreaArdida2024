...
if(!USE_BA_INTERSECT_CACHE){
  ...
  #writeVector(ba_effis_cos24_crop_vec,"ba_effis_cos24_crop_vec.shp")  

  readr::write_rds(ba_effis_cos24_crop_vec, "ba_effis_cos24_crop_vec.rds")
...
elev_stages_colors <- c("#2962AD", "#51A4E8", "#33B873", "#E8CF12", "#853115")
...
ba_elev_dens <- ggplot(ba_elev_dem, aes(x = dem)) +
  ...
  annotate("text", x = 5, y = 0.0017, label = elev_stages_labs[1], color = "black", size = 3) +
  annotate("text", x = 250, y = 0.0017, label = elev_stages_labs[2], color = "black", size = 3) +
  annotate("text", x = 550, y = 0.0017, label = elev_stages_labs[3], color = "black", size = 3) +
  annotate("text", x = 850, y = 0.0017, label = elev_stages_labs[4], color = "black", size =3) +
  annotate("text", x = 1150, y = 0.0017, label = elev_stages_labs[5], color = "black", size = 3) +
  annotate("text", x = 1400, y = 0.0017, label = elev_stages_labs[6], color = "black", size = 3) +
  labs(title = "Distribuição dos incêndios por altitude", 
       x = "Altitude (metros)", y = "Densidade de ocorrências") +
  theme_minimal()
...
ba_elev_bar <- ggplot(stage_perc, aes(x = Piso, y = Percentagem, fill = Piso)) +
  ...
  labs(title = "Percentagem de incêndios por patamar altitudinal", 
