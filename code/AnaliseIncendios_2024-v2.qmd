...
Os dados preliminares em formato raster GeoTIFF podem ser descarregados no seguinte [link (com metadados)](./tmp_data/SPT_RBR_NBR_S2MSI_E2024_R003P003_32629_20241015_v02.zip)
...
Um total de **`{r} round(sum(ba_pp$ba_len_km), 2)` Km de percursos pedestres** (incluindo trilhos 
